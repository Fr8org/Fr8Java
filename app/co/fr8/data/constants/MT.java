...
public enum MT {
   ...
   * @param name the friendlyName of the MT
   */
  ...
  /**
   * Getter for the friendlyName property
   *
   * @return the string value of the friendlyName property
   */
  public String getFriendlyName() {
    return friendlyName;
  }

  public static MT findByFriendlyName(String name) {
    for (MT enumItem : values()) {
      if (enumItem.getFriendlyName().equals(name)) {
        return enumItem;
      }
    }
    return null;
