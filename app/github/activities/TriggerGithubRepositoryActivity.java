...
public class TriggerGithubRepositoryActivity extends AbstractTerminalActivity<TriggerGithubRepositoryActivityUI> {
  ...
  public void initialize() {
    List<ListItem> repoListItems = GitHubService.getInstance().
        getOwnedRepositoriesAsListItems(getActivityContext().getAuthorizationToken().getToken(),
    ...
    repoList.getEvents().add(ControlEvent.getRequestConfigOnChange());
  ...
  public void followUp() {
    ...
    if (crate.getRawContent() != null) {
      ...
      if (issue.isSelected()) {
        Logger.debug("Issue is selected. Adding Crate Description for issue.");
